...
public class postGUI {
	...
	private void initialize() {
		...
		sl_panel_big.putConstraint(SpringLayout.SOUTH, lbl_login, -984, SpringLayout.SOUTH, panel_big);
		...
		sl_panel_big.putConstraint(SpringLayout.NORTH, pn_underimg, 917, SpringLayout.NORTH, panel_big);
		sl_panel_big.putConstraint(SpringLayout.SOUTH, pn_underimg, -10, SpringLayout.SOUTH, panel_big);
		sl_panel_big.putConstraint(SpringLayout.EAST, pn_underimg, -10, SpringLayout.EAST, panel_big);
		panel_big.add(pn_underimg);

		JPanel pn_small = new JPanel();
		sl_panel_big.putConstraint(SpringLayout.WEST, pn_underimg, 158, SpringLayout.EAST, pn_small);
		...
		btn_in.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (!txtPeriod.getText().equals("마우스를 클릭하면 달력이 나타납니다.") && !temp2.equals("선택안함")
						&& !temp3.equals("선택안함")) {
