...
public class JoinGUI {
	...
	private void initialize() {
		...
		lblNewLabel.setFont(new Font("a펜글씨B", Font.PLAIN, 12));
		lblNewLabel.setBounds(143, 203, 57, 15);
		panel_2.add(lblNewLabel);

		idInput = new JTextField();
		
		idInput.setFont(new Font("a펜글씨B", Font.PLAIN, 17));
//		".\\Image\\exitarrow.png"
		...
		label_3.setFont(new Font("a펜글씨B", Font.PLAIN, 12));
		label_3.setBounds(143, 307, 57, 15);
		panel_2.add(label_3);

		nameInput = new JTextField();
		nameInput.setFont(new Font("a펜글씨B", Font.PLAIN, 17));
		...
		label_6.setFont(new Font("a펜글씨B", Font.PLAIN, 12));
